                ...
                <div class="content form" id="user_info">
                    ...
                    <div class="user_address">
                        ...
                        <div class="addr_content">
                            ...
                            <div class="row 
                                @if ($address->is_default_address()) hightlight @endif" id="address_{{ $address->id }}">
                                <div class="num">&#35; {{ $key + 1 }} 
                                ...
                                <div class="action">
                                    ...
                                    <div>
                                        <a href="{{ route('address-edit', ['user_address' => $address->id]) }}">Edit</a>
                                    </div>
                                    
                                    @if (!$address->is_default_address())
                                        <div>
                                            <form method="post" action="/address/{{ $address->id }}" id="address_delete_{{ $address->id }}"
